function classify() {
  ...
  names = filterOut(names, ['Node', 'NodeList', 'RadioNodeList', 'HTMLAllCollection', 'HTMLCollection', 'HTMLOptionsCollection', 'HTMLFormControlsCollection'], WhatWg);
  /**
   * Document
  ...
  */
  ...
  names = filterOut(names, ['PopStateEvent', 'PointerEvent', 'UIEvent', 'TextEvent', 'WheelEvent', 'BeforeInstallPromptEvent', 'PageTransitionEvent', 'FocusEvent', 'MouseEvent', 'HashChangeEvent', 'ErrorEvent', 'DragEvent', 'CompositionEvent', 'BeforeUnloadEvent', 'ClipboardEvent', 'SecurityPolicyViolationEvent', 'KeyboardEvent', 'InputEvent' ], WhatWg)
  /**
   * Aborting
  ...
  */
   ...
   */
  names = filterOut(names, ['Worker', 'SharedWorker', 'ServiceWorker', 'ServiceWorkerContainer', 'Cache', 'caches', 'CacheStorage', 'Worklet', 'NavigationPreloadManager'], WhatWg)
  
  /**
   * window object
   * https://html.spec.whatwg.org/multipage/window-object.html#window
   */
  names = filterOut(names, ['window', 'self', 'document', 'name', 'location', 'history', 'event', 'customElements', 'locationbar', 'menubar', 'personalbar', 'scrollbars', 'statusbar', 'toolbar', 'status', 'close', 'closed', 'stop', 'focus', 'blur', 'frames', 'length', 'top', 'opener', 'parent', 'frameElement', 'open', 'navigator', 'clientInformation', 'applicationCache', 'originIsolated', 'alert', 'confirm', 'prompt', 'print', 'postMessage', 'find', 'offscreenBuffering', 'styleMedia', 'queueMicrotask'], WhatWg);
   ...
   */
  names = filterOut(names, ['XMLHttpRequestUpload', 'XMLHttpRequestEventTarget', 'XMLHttpRequest', 'FormData', 'ProgressEvent'], WhatWg);
   ...
   */
  names = filterOut(names, ['ReadableStream', 'ReadableStreamDefaultReader', 'WritableStream', 'WritableStreamDefaultWriter', 'CountQueuingStrategy', 'ByteLengthQueuingStrategy'], WhatWg)
  ...
  names = filterOut(names, ['moveTo','moveBy','resizeTo','resizeBy','scroll','scrollTo','scrollBy', 'scrollX', 'scrollY', 'screenX', 'screenY', 'innerHeight', 'innerWidth', 'outerHeight', 'outerWidth', 'pageXOffset', 'pageYOffset', 'devicePixelRatio', 'screenLeft', 'screenTop'], W3C);
   ...
   */
  names = filterOut(names, ['ImageCapture', 'MediaStream', 'MediaStreamTrackEvent', 'MediaStreamTrack', 'MediaStreamEvent', 'MediaSettingsRange', 'MediaRecorder', 'MediaEncryptedEvent', 'MediaCapabilities', 'BlobEvent', 'PhotoCapabilities', 'OverconstrainedError', 'InputDeviceInfo', 'CanvasCaptureMediaStreamTrack'], W3C)
  ...
  */
  names = filterOut(names, ['WakeLock', 'WakeLockSentinel', 'PushSubscriptionOptions'], W3C)
  ...
  */
  names = filterOut(names, ['Credential', 'CredentialsContainer', 'FederatedCredential', 'PasswordCredential', 'PublicKeyCredential'], W3C)
  ...
  */
   ...
   */
  names = filterOut(names, ['MediaError', 'SourceBuffer', 'SourceBufferList',  'VideoPlaybackQuality', 'VideoTrackList', 'AudioTrackList', 'AudioTrack', 'VideoTrack', 'TextTrackList', 'TextTrack', 'TextTrackCueList', 'TextTrackCue', 'TimeRanges', 'TrackEvent'], W3C)
  names = filterOut(names, ['MediaSource', 'SourceBuffer', 'SourceBufferList', 'VideoPlaybackQuality'], W3C);
  
  // https://drafts.fxtf.org/geometry/
  names = filterOut(names, ['DOMRectReadOnly', 'DOMRectList', 'DOMRect', 'DOMPointReadOnly', 'DOMPoint', 'DOMMatrixReadOnly', 'DOMMatrix', 'DOMQuad', ], W3C);
  ...
  */
   ...
   */
  names = filterOut(names, ['FileSystemDirectoryHandle','FileSystemFileHandle','FileSystemHandle','FileSystemWritableFileStream', 'showDirectoryPicker', 'showOpenFilePicker', 'showSaveFilePicker', 'chooseFileSystemEntries', 'getOriginPrivateDirectory'], WICG);
  
  /**
   * Web HID
   * https://wicg.github.io/webhid/
   */
  names = filterOut(names, ['HID','HIDCollectionInfo','HIDConnectionEvent','HIDDevice','HIDInputReportEvent','HIDReportInfo','HIDReportItem',], WICG);
